...
<template>
    <div>
        ...
        <a-row class="mt20">
            <a-col :span="8">
                <a-form ref="formRef" :model="form" layout="vertical" name="nest-messages" :rules="rules">
                    ...
                    <a-form-item :label="form.subject ? '所属学科' : '所属学科(请务必选择)'" name="subject" has-feedback>
                        <a-select :disabled="toggle" v-model:value="form.subject" @change="changeSubject">
                            <a-select-option :value="l.value" v-for="(l, i) in subjects" :key="i">
                                {{ l.label }}
                            </a-select-option>
                        </a-select>
                    </a-form-item>
                    ...
                    <a-form-item :label="form.class ? '所属班级' : '所属班级(请务必选择)'" name="class" has-feedback>
                        <a-select :disabled="toggle" v-model:value="form.class">
                            <a-select-option :value="l.value"
                                v-for="(l, i) in classList.filter((item: any) => item.subject == form.subject)" :key="i">
                                {{ l.label }}
                            </a-select-option>
                        </a-select>
                    </a-form-item>
        ...
        <a-modal v-model:visible="visible" title="个人信息" width="30%" :footer="null">
            <a-card hoverable style="width: 100%">
                ...
                <div class="mt10">
                    <a-card-meta :title="userInfo.phone"
